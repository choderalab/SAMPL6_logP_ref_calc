...
def run_yank(job_id, n_jobs):
    ...
    molecules_files_pattern = os.path.join(pdb_dir, '*_water_octanol_0.0_0.2705_0.7295_GAFF_tip3pFB_equil.pdb')
    molecule_ids = [os.path.basename(molecule_file)[:-4] for molecule_file in glob.glob(molecules_files_pattern)] # makes a list of just the system IDs (ie SM13_octanol_0.0_1.0_GAFF_tip3pFB_equil instead of SM13_octanol_0.0_1.0_GAFF_tip3pFB_equil.pdb)
    ...
    for i, molecule_id in enumerate(molecule_ids):
        ...
        phase2_molecule_id = phase1_molecule_id.replace("_water_octanol_0.0_0.2705_0.7295_GAFF_tip3pFB_equil", "_water_0.0_1.0_GAFF_tip3pFB_equil")
