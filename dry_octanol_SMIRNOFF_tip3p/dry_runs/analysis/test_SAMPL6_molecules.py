...
trials = glob.glob("/data/chodera/misik/SAMPL6_logP_ref_calc/dry_octanol_SMIRNOFF_tip3p/dry_runs/*/dry_yank_output/")
...
for idx in range(len(trials)):
    ...
    # Added to see the results of partial analysis before errror
        trial_num = trials[idx].split("/")[-3]
        filename = "SAMPL6_mols_trial_" + trial_num + "_SMIRNOFF_tip3p_dryoct.json"
