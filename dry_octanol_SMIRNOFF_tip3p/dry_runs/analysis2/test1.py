...
for trial_number in trials:
    ...
    trials = glob.glob("/data/chodera/misik/SAMPL6_logP_ref_calc/dry_octanol_SMIRNOFF_tip3p/dry_runs/t{}/dry_yank_output/".format(trial_number))
    all_mols = []
    ...
    filename = "trial{}_dry_octanol_SMIRNOFF_tip3p.pickle".format(trial_number)
