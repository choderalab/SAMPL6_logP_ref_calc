...
# RESULTS_DIR = os.path.join('../..','dry_runs/t1/dry_yank_results') #where the json file will be stored
...
#OUTPUT_DIR = os.path.join('../..','dry_runs/t1/dry_yank_outputs')# where the yank results/output will be stored
...
def run_yank(job_id, n_jobs):
    ...
    #pdb_dir = "dry_runs/t1/t1_dry_oct_pdbs"
    pdb_dir = "./t1_dry_oct_pdbs"
    ...
    #openmm_system_dir = "dry_runs/t1/t1_dry_oct_XMLs"
    openmm_system_dir = "./t1_dry_oct_XMLs"
    ...
    molecules_files_pattern = os.path.join(pdb_dir, '*_octanol_0.0_1.0_GAFF_tip3p_equil.pdb')
    ...
    for i, molecule_id in enumerate(molecule_ids):
        ...
        phase2_molecule_id = phase1_molecule_id.replace("_octanol_0.0_1.0_GAFF_tip3p_equil", "_water_0.0_1.0_GAFF_tip3p_equil")
