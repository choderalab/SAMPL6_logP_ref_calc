...
RESULTS_DIR = os.path.join('../..','equilibration/1/extra_equild')
MOLECULES_DONE_FILEPATH = os.path.join(RESULTS_DIR, 'equil.json') #file which listed completed runs
...
def run_equil(job_id, n_jobs):
    ...
    pdb_dir = os.path.join('../..', 'equilibration/1/system_outputs/')
