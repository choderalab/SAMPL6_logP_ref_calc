...
RESULTS_DIR = os.path.join('../..','equilibration/1/equil_results')
...
OUTPUT_DIR = os.path.join('../..','equilibration/1/equil_pdbs/')
...
def run_equil(job_id, n_jobs):
    ...
    pdb_dir = os.path.join('../..', 'equilibration/1/output_files/')
