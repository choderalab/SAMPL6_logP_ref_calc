...
RESULTS_DIR = os.path.join('../..','equilibration/3/equil_results')
...
OUTPUT_DIR = os.path.join('../..','equilibration/3/equil_pdbs/')
...
def run_equil(job_id, n_jobs):
    ...
    pdb_dir = os.path.join('../..', 'equilibration/3/output_files/')
