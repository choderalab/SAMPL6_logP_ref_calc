...
for trial_number in trials:
    ...
    trials = glob.glob("/data/chodera/misik/SAMPL6_logP_ref_calc/wet_octanol_GAFF_opc/t{}/wet_yank_output/".format(trial_number))
    all_mols = []
    ...
    filename = "trial{}_wet_octanol_GAFF_opc.pickle".format(trial_number)
