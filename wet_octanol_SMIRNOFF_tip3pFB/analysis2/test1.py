...
for trial_number in trials:
    ...
    trials = glob.glob("/data/chodera/misik/SAMPL6_logP_ref_calc/wet_octanol_SMIRNOFF_tip3pFB/t{}/wet_yank_output/".format(trial_number))
    all_mols = []
    ...
    filename = "trial{}_wet_octanol_SMIRNOFF_tip3pFB.pickle".format(trial_number)
